...
def compute_errors(pitch,pitch_praat,rate,print_result=False):
    ...
    pitch(numpy array): computed pitch contour, unvoiced frames should set corresponding pitch value as 0
    pitch_praat(numpy array): groutnd truth pitch contour generated by praat
    print_results(bool): Boolean variable to decide whether to print the result for individual wav file, default False
...
def compute_errors_mean(pitches,pitches_praat,rate=12000):
    ...
    pitch(list of numpy array): computed pitch contours for all utterances
